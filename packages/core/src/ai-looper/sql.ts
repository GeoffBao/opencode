...
export const AILooperArtifactTable = sqliteTable(
  "ai_looper_artifact",
  {
    ...
    content: text({ mode: "json" }).$type<AiLooper.Artifact["content"]>().notNull(),
...
export const AILooperEvidenceTable = sqliteTable(
  "ai_looper_evidence",
  {
    ...
    ref: text().notNull(),
    metadata: text({ mode: "json" }).$type<AiLooper.Evidence["metadata"]>(),
    ...Timestamps,
  },
...
export const AILooperExternalEventTable = sqliteTable(
  "ai_looper_external_event",
  {
    ...
    payload: text({ mode: "json" }).$type<AiLooper.ExternalEvent["payload"]>().notNull(),
...
export const AILooperExternalWriteTable = sqliteTable(
  "ai_looper_external_write",
  {
    ...
    payload: text({ mode: "json" }).$type<AiLooper.ExternalWrite["payload"]>().notNull(),
...
export const AILooperKnowledgeAssetCandidateTable = sqliteTable(
  "ai_looper_knowledge_asset_candidate",
  {
    ...
    evaluation_state: text().$type<AiLooper.KnowledgeAssetCandidate["evaluation_state"]>().notNull(),
    ...Timestamps,
  },
...
export const AILooperAuditRecordTable = sqliteTable(
  "ai_looper_audit_record",
  {
    ...
    action: text().notNull(),
    before: text({ mode: "json" }).$type<AiLooper.AuditRecord["before"]>(),
    after: text({ mode: "json" }).$type<AiLooper.AuditRecord["after"]>(),
    reason: text(),
