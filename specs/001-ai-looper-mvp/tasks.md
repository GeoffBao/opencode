...
- [ ] T027 [P] [US1] Add contract test for `GET /ai-looper/tasks` in `packages/server/test/contract/ai-looper-tasks.test.ts`
- [ ] T028 [P] [US1] Add contract test for `GET /ai-looper/tasks/{taskCapsuleId}` in `packages/server/test/contract/ai-looper-task-detail.test.ts`
...
- [ ] T032 [US1] Implement Teambition assigned work item listing via TeambitionAdapter in `packages/core/src/ai-looper/teambition.ts`
- [ ] T033 [US1] Implement SourceTask snapshot creation and visibility states in `packages/core/src/ai-looper/taskrun.ts`
- [ ] T034 [US1] Implement TaskCapsule creation and active TaskRun lookup in `packages/core/src/ai-looper/taskrun.ts`
- [ ] T035 [US1] Implement routing decision creation for feature/task/bug and size/risk in `packages/core/src/ai-looper/routing.ts`
- [ ] T036 [US1] Implement missing, inaccessible, deleted, archived, and reassigned source handling in `packages/core/src/ai-looper/teambition.ts`
...
- [ ] T072 [P] [US4] Add contract test for `GET /ai-looper/runs/{taskRunId}` detail shape in `packages/server/test/contract/ai-looper-run-detail.test.ts`
...
- [ ] T074 [P] [US4] Add cancellation contract test for `POST /ai-looper/runs/{taskRunId}/cancel` in `packages/server/test/contract/ai-looper-cancel.test.ts`
- [ ] T075 [P] [US4] Add cancellation cleanup/unresolved-effects test in `packages/core/test/ai-looper/cancellation.test.ts`
...
- [ ] T077 [US4] Implement `GET /ai-looper/runs/{taskRunId}` handler in `packages/server/src/handlers/ai-looper.ts`
- [ ] T078 [US4] Implement `POST /ai-looper/runs/{taskRunId}/cancel` handler in `packages/server/src/handlers/ai-looper.ts`
...
- [ ] T081 [US4] Implement authorized cancellation and unresolved-effects reporting in `packages/core/src/ai-looper/taskrun.ts`
- [ ] T082 [US4] Record audit entries for human interventions and cancellations in `packages/core/src/ai-looper/audit.ts`
...
- [ ] T083 [P] [US5] Add contract test for `POST /ai-looper/runs/{taskRunId}/human-evidence` in `packages/server/test/contract/ai-looper-human-evidence.test.ts`
- [ ] T084 [P] [US5] Add contract test for `POST /ai-looper/runs/{taskRunId}/delivery-summary` in `packages/server/test/contract/ai-looper-delivery-summary.test.ts`
- [ ] T085 [P] [US5] Add contract test for `POST /ai-looper/runs/{taskRunId}/worktime` in `packages/server/test/contract/ai-looper-worktime.test.ts`
