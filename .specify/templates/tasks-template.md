...
**Tests**: Verification tasks are REQUIRED. Include the unit, contract, integration,
recovery, authorization, and fault-injection coverage required by the specification
and plan; omit a category only when the plan records why it does not apply.
...
- [ ] T010 Define durable recovery and restart verification
- [ ] T011 Define idempotency coverage for external writes and duplicate events
- [ ] T012 Define authorization, approval, and audit verification
...
- [ ] TXXX Recovery and duplicate-event fault-injection tests
- [ ] TXXX Audit evidence and observability verification
